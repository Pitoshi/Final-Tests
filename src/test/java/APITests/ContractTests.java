...
public class ContractTests {
    ...
    public void getEmployeeById() {
        ...
        given()
                .basePath("employee")
                .when()
                .get("{id}", createEmployeeDB(new EmployeeEntity(BAD_REQUEST), russianDB).getId())
                .then()
                .assertThat()
                .statusCode(STATUS_CODE_OK)
                .header("Content-Type", JSON);
    ...
    public void changeEmployeeData() {
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .when()
                .patch("{id}", createEmployeeDB(new EmployeeEntity(BAD_REQUEST), fullFieldsRussianDB).getId())
                .then()
                .assertThat()
                .statusCode(STATUS_CODE_OK)
                .header("Content-Type", JSON);
